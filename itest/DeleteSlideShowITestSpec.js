...
describe('DeleteSlideShow', function () {
  ...
  it('deletes a single slide show.', function (done) {
    ...
    if (testDelay > 0) {
      var messageRequest = {
        ...
        message: 'Running DeleteSlideShow in ' + testDelay + ' seconds...'
      }
    ...
    console.log('Running deleteSlideShow...')
    ...
    setTimeout(function () {
      ...
      if (request0.uploadId) {
        uploadId = request0.uploadId
            ...
            client.updateSlideShow(request0).then(function (httpResponse) {
          let response = httpResponse.data
