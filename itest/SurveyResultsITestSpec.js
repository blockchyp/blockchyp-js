...
describe('SurveyResults', function () {
  ...
  it('returns results for a single survey question.', function (done) {
    ...
    if (testDelay > 0) {
      var messageRequest = {
        ...
        message: 'Running SurveyResults in ' + testDelay + ' seconds...'
      }
    ...
    console.log('Running surveyResults...')
    ...
    setTimeout(function () {
      ...
      if (request0.uploadId) {
        uploadId = request0.uploadId
            ...
            client.surveyQuestions(request0).then(function (httpResponse) {
          let response = httpResponse.data
