...
describe('MerchantInvoiceDetail', function () {
  ...
  it('can retrieve merchant invoice detail', function (done) {
    ...
    if (testDelay > 0) {
      var messageRequest = {
        ...
        message: 'Running MerchantInvoiceDetail in ' + testDelay + ' seconds...'
      }
    ...
    console.log('Running merchantInvoiceDetail...')
