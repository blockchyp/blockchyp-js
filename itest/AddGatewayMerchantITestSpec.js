...
describe('AddGatewayMerchant', function () {
  ...
  it('can add a gateway merchant', function (done) {
    ...
    if (testDelay > 0) {
      var messageRequest = {
        ...
        message: 'Running AddGatewayMerchant in ' + testDelay + ' seconds...'
      }
    ...
    console.log('Running addGatewayMerchant...')
