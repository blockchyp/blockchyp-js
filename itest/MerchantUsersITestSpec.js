...
describe('MerchantUsers', function () {
  ...
  it('returns a list of all merchant users and invites.', function (done) {
    ...
    if (testDelay > 0) {
      var messageRequest = {
        ...
        message: 'Running MerchantUsers in ' + testDelay + ' seconds...'
      }
    ...
    console.log('Running merchantUsers...')
