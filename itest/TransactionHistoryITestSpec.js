...
describe('TransactionHistory', function () {
  ...
  it('can retrive transaction history', function (done) {
    ...
    if (testDelay > 0) {
      var messageRequest = {
        ...
        message: 'Running TransactionHistory in ' + testDelay + ' seconds...'
      }
    ...
    console.log('Running transactionHistory...')
    ...
    setTimeout(function () {
      ...
      if (request0.uploadId) {
        uploadId = request0.uploadId
          ...
          return client.transactionHistory(request)
        })
        .then(function (httpResponse) {
          let response = httpResponse.data
