  ...
  it('delete a survey question.', function (done) {
    ...
    if (testDelay > 0) {
      var messageRequest = {
        ...
        message: 'Running DeleteSurveyQuestion in ' + testDelay + ' seconds...'
      }
    ...
    setTimeout(function () {
      ...
      if (request0.uploadId) {
        uploadId = request0.uploadId
            ...
            client.updateSurveyQuestion(request0).then(function (httpResponse) {
          let response = httpResponse.data
          ...
          return client.deleteSurveyQuestion(request)
        })
        .then(function (httpResponse) {
          let response = httpResponse.data
